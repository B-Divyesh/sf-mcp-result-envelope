...
- Add typed ESM and CommonJS library builds.
- Add bounded result manifests, summaries, schemas, pages, and async chunks.
...
- Put a populated sample envelope in the phone demo's first viewport and expose offline use in the landing facts.
- Verify the async iterator, complete CLI help surface, and every documented envelope metadata field.
